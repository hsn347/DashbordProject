...
import { Package, DollarSign, Image as ImageIcon, Tag, Globe, MapPin, Boxes, Loader2, CheckCircle2, XCircle } from "lucide-react";
...
export default function Products() {
  ...
  return (
    <div className="space-y-10 mx-auto max-w-4xl">
                  ...
                  <div className="p-4 text-center">
                    {uploading ? (
                      ...
                      <>
                        ...
                        <p className="font-medium text-text-muted text-sm">Click to upload image</p>
                      </>
                    )}
                  </div>
                )}
      ...
      <div>
        <h3 className="mb-6 font-bold text-text-primary text-xl">Recent Products</h3>
        <DisplayProducts />
      </div>
